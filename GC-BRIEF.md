...
6. **"Their economy is unwritten" → then "pond0x settles it."** Both wrong. First: the $692.5M ledger was called fiction-or-early until hwonder's MetaProofs post showed it as a booked attestation sheet. Then the desk over-corrected by tying Geoff's ledger to pond0x.com's $43M distributed rewards as if one economy — operator clarified, and pond0x's own Terms confirm it: **GEOFF and POND are separate projects.** The pond0x Terms describe a self-contained DEX/mining/yield economy with its own Rewards language and zero mentions of Geoff, StackNet, or metaproofs; and Geoff's real Terms (www.geoff.ai/terms — governing law Singapore) return the silence: zero mentions of pond/POND/PAPER/metaproofs, while explicitly stating the AI models on their network are **developed, trained, and maintained by third parties**, nodes are run by **independent AISPs** the Company has no authority over, and routers/TEEs/payment protocols are third-party operated. Standing truth: **Geoff's metaproof ledger ($692.5M booked / $0 paid / treasury untouched) has no visible settlement rail anywhere public.** Pond0x's payouts are tracked separately as independent ecosystem context — never as Geoff settlement.
