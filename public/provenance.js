...
const METRICS = [
  ...
  ["trixPacksMinted", "Mixed", "Pack counts, quotes and odds are API-reported, not independently verified. Rates use saved samples; paid costs use observed receipts. Colors follow a user-supplied CSS reference, not binary decoding rules or the current shop label palette. Void sheen is approximate: the reference omits its stops. Box types are separate from rarity outcomes; holders are unknown.", ["trix.geoff.packs", "trix.geoff.packs.purchaseAudit"]],
