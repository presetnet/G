...
export async function runSniff({ forceMiningSurface = false } = {}) {
  ...
  return {
    ...
    summary: {
      ...
      miningSurfaceCheckedAt: bySource["surface.mining"]?.checkedAt ?? null,
      miningSurfaceCached: Boolean(bySource["surface.mining"]?.cached),
      miningSurfaceAgeMs: bySource["surface.mining"]?.ageMs ?? null,
