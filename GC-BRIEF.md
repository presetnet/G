...
- And the "free" label just died in real time — on OUR side of the table, which is the funniest part. OpenCode launched a subscription called **Go**: $5 for the first month, then $10/month, and the headline mystery model rides it as a limited-time promo ("Ox Alpha Free, unlimited"). Its public paper record still read $0 days earlier. We were mid-investigation of who eats the subsidy bill when the meter got bolted on. Watch which ghosts flip to paid next; every one that does is the hidden payer asking for his money back. Bonus absurdity: Geoff's brand line is "Go Turbo" and OpenCode's product is literally named Go — two unrelated economies, same three-letter word.
